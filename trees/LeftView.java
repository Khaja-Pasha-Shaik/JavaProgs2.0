...
public class LeftView {
    ...
    //do a level order traversal and grab the first element in each traversal
    ...
    public static void main(String[] args) {
        ...
        for (List<Integer> ul : ds){
            System.out.print(ul.getFirst()+" ");
        }
    }

    private static void leftView(TreeNode root, List<List<Integer>> ds) {
